...
* 📦🆓💰 [Bright Data](https://github.com/brightdata/brightdata-mcp) ⭐ 2,601 | 🐛 24 | 🌐 JavaScript | 📅 2026-08-12 — Real-time web search, scraping, and structured data extraction from 60+ sources (Amazon, LinkedIn, TikTok, Google Maps, etc.) with CAPTCHA and anti-bot bypass. Free tier: 5,000 requests/month.
...
* 📦🆓 [OpenOSINT](https://github.com/OpenOSINT/OpenOSINT) ⭐ 1,429 | 🐛 16 | 🌐 Python | 📅 2026-08-17 — AI-powered OSINT agent with interactive REPL, MCP server, and CLI.
* 📦🆓 [Darknet MCP](https://github.com/badchars/darknet-mcp-server) ⭐ 311 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-11 — 66 tools for dark web and breach intelligence: ransomware group tracking and victim listings, stealer logs, HIBP breach lookups, IntelX search, Tor .onion fetching and exit-node checks, MalwareBazaar/ThreatFox/URLhaus feeds, and Bitcoin address intel. Many tools work with no API key; premium sources unlock with your own keys. `npx darknet-mcp-server`
